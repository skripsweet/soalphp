...
function next_page(){
    ...
    var link_baru ='<span style="padding:6px;font-size:95%" class="tombol" onclick="prev_page()">Sebelumnya</span><span style="padding:6px;font-size:95%" class="tombol" onclick="koreksi_simpan()">Koreksi</span>';
    var link_nav = '<div id="nav_soal" style="margin-top:25px"><span style="padding:6px;font-size:95%" class="tombol" onclick="koreksi_simpan()">Koreksi</span></div>';
        }
    else {
...
function prev_page(){
    ...
    var link_baru ='<span style="padding:6px;font-size:95%" class="tombol" onclick="next_page()">Selanjutnya</span>';
    //var link_baru = '<span style="padding:6px;font-size:95%" class="tombol" onclick="prev_page()">Sebelumnya</span>';
        }
    else {
    var link_baru ='<span style="padding:6px;font-size:95%" class="tombol" onclick="prev_page()">Sebelumnya</span><span style="padding:6px;font-size:95%" class="tombol" onclick="next_page()">Selanjutnya</span>'; 
        }
